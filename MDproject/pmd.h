...
#define MSDSAMPLES 50
double msdsamples[MSDSAMPLES]={0.0};
double cvsamples[MSDSAMPLES]={0.0};
int imsdsamples=0,nmsdsamples[MSDSAMPLES]={0};
...
double Lattice;     /* Lattice constant for single unit cell */
...
int avgcount=0;
double avgtemp=0,avgpotE=0,avgtotE=0,avgpressure=0;
